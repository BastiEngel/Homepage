...
<footer id="contact" class="bg-surface relative px-6 py-16 md:px-12">
	<div class="mx-auto max-w-6xl text-center" use:scrollReveal>
		<h2 class="font-heading text-text text-2xl font-bold">
			Get in Touch
		</h2>

		<a
			href="mailto:{config.meta.email}"
			class="text-accent hover:text-accent-hover mt-4 inline-block text-lg transition-colors duration-200"
		>
			{config.meta.email}
		</a>
			...
			<div class="mt-6 flex justify-center gap-4">
				{#each config.meta.socialLinks as link}
					<a
						...
						class="text-text-muted hover:text-accent flex h-10 w-10 items-center justify-center rounded-full transition-colors duration-200"
