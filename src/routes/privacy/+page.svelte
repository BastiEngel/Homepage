...
<main class="relative z-[6] mx-auto max-w-3xl px-6 mt-16 py-12 md:px-12">
	...
	<div class="text-text space-y-6 text-sm leading-relaxed">
		...
		<section>
			<h3 class="mb-1 font-bold">data collection on this website</h3>
			...
			<p class="mt-3"><strong>how do we collect your data?</strong></p>
			...
			<p class="mt-3"><strong>what do we use your data for?</strong></p>
			...
			<p class="mt-3"><strong>what rights do you have regarding your data?</strong></p>
		...
		<section>
			<h2 class="mb-2 text-base font-bold">2. hosting</h2>
			...
			<p class="mt-2">External hosting is carried out for the purpose of fulfilling contracts with our potential and existing customers and in the interest of a secure, fast and efficient provision of our online offer by a professional provider.</p>
		</section>

		<section>
			<h2 class="mb-2 text-base font-bold">3. general information and mandatory information</h2>
			<h3 class="mb-1 font-bold">data protection</h3>
			...
			<p class="mt-2">When you use this website, various personal data is collected. Personal data is data with which you can be personally identified. This privacy policy explains what data we collect and what we use it for. It also explains how and for what purpose this is done.</p>
			<p class="mt-2">We would like to point out that data transmission over the Internet (e.g. when communicating by email) may have security gaps. Complete protection of data against access by third parties is not possible.</p>
		</section>

		<section>
			<h3 class="mb-1 font-bold">revocation of your consent to data processing</h3>
		...
		<section>
			<h3 class="mb-1 font-bold">right to lodge a complaint with the competent supervisory authority</h3>
			<p>In the event of violations of the GDPR, data subjects have the right to lodge a complaint with a supervisory authority, in particular in the Member State of their habitual residence, their place of work or the place of the alleged violation.</p>
		</section>

		<section>
			<h3 class="mb-1 font-bold">right to data portability</h3>
		...
		<section>
			<h3 class="mb-1 font-bold">information, correction and deletion</h3>
		...
		<section>
			<h2 class="mb-2 text-base font-bold">4. data collection on this website</h2>
			<h3 class="mb-1 font-bold">contact form</h3>
			<p>If you send us inquiries via the contact form, your details from the inquiry form, including the contact details you provided there, will be stored by us for the purpose of processing the inquiry and in case of follow-up questions. We will not pass on this data without your consent.</p>
			<p class="mt-2">The processing of this data is based on Art. 6 (1) (b) GDPR if your request is related to the performance of a contract or is necessary for the implementation of pre-contractual measures. In all other cases, the processing is based on our legitimate interest in the effective processing of the inquiries addressed to us (Art. 6 (1) (f) GDPR) or on your consent (Art. 6 (1) (a) GDPR) if this has been requested.</p>
			<p class="mt-2">The data you enter in the contact form will remain with us until you request us to delete it, revoke your consent to storage or the purpose for data storage no longer applies. Mandatory legal provisions — in particular retention periods — remain unaffected.</p>
		</section>
	</div>
</main>
